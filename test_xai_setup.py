#!/usr/bin/env python3
"""Test XAI/Grok provider and configuration support."""
...
if __name__ == "__main__":
    print("=" * 60)
    print("Testing XAI/Grok Provider Configuration")
    print("=" * 60)
    print()
    ...
    print()
    print("Use the default model in your config:")
    print(f"  defaultModel: {config_json['defaultModel']}")
